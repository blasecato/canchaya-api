...
export declare const tournamentCatalogItemSelect: {
    created_by: true;
    associations: {
        select: {
            id: true;
...
export declare function toTournamentCatalogItemResponse(tournament: TournamentCatalogItemRecord, canManage?: boolean): TournamentCatalogItemResponseDto;
